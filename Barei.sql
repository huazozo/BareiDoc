...
create table GROUP_BUY_ITEM(
    ...
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('Petkit 小佩智能感應式除臭貓砂盆','貓砂盆',2380,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('韓系makesure 麻薯半封閉式貓砂盆-三色','貓砂盆',2580,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('【哈燒新品】UAH 貓砂盆智能伴侶-除臭專用-二代','貓砂盆',780,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('PIDAN 貓咪防砂墊 貓砂墊','貓砂墊',499,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('Petkit 小佩 寵物智能去味器-除臭首推','去味器',790,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('PETKIT 寵物智能去味器_濾心','去味器',229,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('【熱銷新品】UAH 負離子寵物梳 不傷健康毛囊','寵物梳',690,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('LED燈-照血管寵物指甲剪-隨機色','指甲剪',180,1, '2022-10-16', '2023-12-30');
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('【團購訂制款】吸盤式瓦楞貓抓板','指甲剪',180,1, '2022-10-16', '2023-12-30');
	INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('『爆玩新品』PIDAN 電動小雪怪-翻滾玩具','玩具',160,1, '2022-10-16', '2023-12-30');   
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('美國CATIT 牆角磨蹭器','磨蹭器',140,1, '2022-10-16', '2023-12-30');    
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('「日本超夯」滿月隧道 貓窩 隧道-兩色','貓隧道',649,1, '2022-10-16', '2023-12-30');    
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('不倒翁 漏食球 可裝飼料零食(貓用)','玩具',165,1, '2022-10-16', '2023-12-30');    
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('PIDAN 寵物餵食針筒','針筒',185,1, '2022-10-16', '2023-12-30');    
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('PETKIT 小佩 寵物按摩梳 神奇梳毛 按摩梳 貓咪最愛','按摩梳',165,1, '2022-10-16', '2023-12-30');      
    INSERT INTO GROUP_BUY_ITEM (GBITEM_NAME, GBITEM_CONTENT, GBITEM_PRICE, GBITEM_STATUS, GBITEM_STARTDATE, GBITEM_ENDDATE)  
    VALUES ('寵物吸盤窩 觀景好幫手','吸盤窩',599,1, '2022-10-16', '2023-12-30');  
